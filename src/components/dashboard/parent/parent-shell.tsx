...
export type ParentView = "overview" | "attendance" | "grades" | "messages";
      ...
      <div className="border-b border-white/10 p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-white/60">Эцэг эхийн портал</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 rounded-lg bg-white/5 p-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-white/60">Эцэг эх</p>
          </div>
        </div>
      </div>
